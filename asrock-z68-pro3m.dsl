DefinitionBlock ("dsdt.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000014)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDEB00E18, 0x01CD)
    ...
    OperationRegion (S4NV, SystemMemory, 0xDEB0DF18, 0x03)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Method (SIOW, 1, NotSerialized)
                {
                    ...
                    If (LEqual (^SIO1.OPT7, 0x40)) {}
                    Else
                    {
                        Store (0x47, ^SIO1.OPT7)
                    }
                    ^SIO1.ENFG (0x0A)
                    ^SIO1.SIOK (Zero)
                    ^SIO1.ENFG (0x0A)
                ...
                Method (CIR._PRW, 0, NotSerialized)
                {
        ...
        Scope (\_GPE)
        {
            ...
            Method (_L0B, 0, NotSerialized)
            {
                ...
                Notify (\_SB.PCI0.RP05.PE2P, 0x02)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDEB12F98, 0x10)
    ...
    Scope (_SB)
    {
        Name (LUCD, Buffer (0x7D)
        {
            ...
            /* 0010 */    0x00, 0x00, 0x00, 0x75, 0x6B, 0x35, 0x33, 0x38, 
            /* 0018 */    0x65, 0x35, 0x34, 0x31, 0x35, 0x61, 0x38, 0x61, 
            /* 0020 */    0x64, 0x34, 0x65, 0x34, 0x30, 0x39, 0x62, 0x36, 
            /* 0028 */    0x63, 0x37, 0x36, 0x37, 0x35, 0x61, 0x61, 0x31, 
            /* 0030 */    0x38, 0x65, 0x30, 0x65, 0x38, 0x39, 0x38, 0x33, 
            /* 0038 */    0x37, 0x64, 0x34, 0x62, 0x62, 0x32, 0x34, 0x36, 
            /* 0040 */    0x62, 0x39, 0x34, 0x64, 0x61, 0x64, 0x36, 0x63, 
            /* 0048 */    0x36, 0x64, 0x31, 0x64, 0x66, 0x33, 0x34, 0x65, 
            /* 0050 */    0x37, 0x30, 0x32, 0x36, 0x31, 0x30, 0x30, 0x30, 
            /* 0058 */    0x30, 0x32, 0x36, 0x46, 0x45, 0x63, 0x65, 0x64, 
    ...
    Method (WAK, 1, NotSerialized)
    {
        ...
        \_SB.PCI0.NWAK (Arg0)
        LEDW (Arg0)
 // wak test       \_SB.PCI0.LPCB.SIOW (Arg0)
    }
}
